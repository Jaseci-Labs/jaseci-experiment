...
MODEL_DIR = ".jaseci/models/jac_nlp/text_seg"
MODEL_PATH = os.path.join(HOME_DIR, MODEL_DIR)
os.makedirs(MODEL_PATH, exist_ok=True)
TFM_MODEL_PATH = os.path.join(MODEL_PATH, TFM_MODEL_NAME)
SPACY_MODEL_PATH = os.path.join(MODEL_PATH, SPACY_MODEL_NAME)
