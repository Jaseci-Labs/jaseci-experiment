BI_ENC_ACTION_CONFIG = {
    ...
    "remote": {
        ...
        "ConfigMap": {
            ...
            "data": {
                "prod_up": "git clone -b vm_test https://github.com/Jaseci-Labs/jaseci-experiment.git; cd jaseci-experiment; cd jaseci_core; source install_live.sh; cd ../jaseci_ai_kit/jac_nlp; pip install -e .[bi_enc]; uvicorn jac_nlp.bi_enc:serv_actions --host 0.0.0.0 --port 80"
